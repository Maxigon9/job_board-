...
?>
<form method="POST" enctype="multipart/form-data" action="template/BorrarTrabajo.php">
  <div class="card border-primary mb-3" style="max-width: 80rem;">
    ...
    <div class="card-body">
      ...
      <button type="submit" name="Accion" value="Borrar" class="btn btn-success">Borrar Trabajo </button>
